...
################################################################################
## Form generated from reading UI file 'mainYdkepo.ui'
##
...
from ..OpenGL.yuvopenglwidget import YUVOpenGLWidget
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.opengl_widget = YUVOpenGLWidget(self.groupBox)
        self.opengl_widget.setObjectName("openGLWidget")
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.opengl_widget.sizePolicy().hasHeightForWidth()
        )
        self.opengl_widget.setSizePolicy(sizePolicy)

        self.horizontalLayout_2.addWidget(self.opengl_widget)
        ...
        self.button_screen_off.setObjectName("button_screen_off")
        ...
        self.button_screen_on.setObjectName("button_screen_on")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_screen_off.setText(
            QCoreApplication.translate("MainWindow", "SCREEN OFF", None)
        )
        self.button_screen_on.setText(
            QCoreApplication.translate("MainWindow", "SCREEN ON", None)
        )
